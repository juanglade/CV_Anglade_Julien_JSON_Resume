...
import d from "sade";
import { yellow as r, red as p } from "yoctocolors";
import { createRequire as h } from "node:module";
import f from "@jsonresume/schema";
...
`
      ...
      (t) => console.error(` ${p(`❌ ${t.message}`)} at ${r(t.path)}.`)
    ), process.exitCode = 1;
  }
});
const g = h(import.meta.url), $ = (e) => {
  const o = g("@jsonresume/schema/sample.resume.json");
  return l(e, JSON.stringify(o, void 0, 2));
}, v = (e, o) => o.render(e), N = w(f.validate), j = async (e) => {
